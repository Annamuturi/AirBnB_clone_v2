...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        ...
        if cln is not None:
            ...
            for param in params:
                our_param = re.fullmatch(param_reg, param)
                if our_param is not None:
                    clname = our_param.group('name')
                    str_v = our_param.group('string')
                    flt_v = our_param.group('float')
                    int_v = our_param.group('integer')
